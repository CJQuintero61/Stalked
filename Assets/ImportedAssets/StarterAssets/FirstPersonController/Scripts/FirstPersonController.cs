...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void Move()
		{
    		...
    		{
        		if (!_staminaManager.CanSprint) wantsToSprint = false;
        		_staminaManager.SetSprinting(wantsToSprint && _input.move != Vector2.zero);
    		}

    		float targetSpeed = wantsToSprint ? SprintSpeed : MoveSpeed;
